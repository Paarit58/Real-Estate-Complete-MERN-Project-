...
import { signin, signup ,protect, signout, updatePassword,forgotPassword,resetPassword} from "../controllers/authController.js";
...
userRouter.route("/:id").get(getUser).patch(protect,updateUser).delete(deleteUser);
